...
(vtname char(20), features char(140), wrate real, drate real, hrate real, wirate real, hirate real, krate real,
PRIMARY KEY (vtname));

insert into VehicleType values ('SUV', '5 seats but larger', 500, 100, 15, 50, 2, 5);
insert into VehicleType values ('Truck', 'Large boy for heavy lifting', 700, 200, 20, 75, 4, 10);
insert into VehicleType values ('Sedan', '5 seats and stuff', 400, 80, 10, 25, 2, 4);
...
(vlicense char(7), make char(20), model char(20), year int, color char(20), odometer real, status char(20), vtname char(20), location char(20), city char(20),
...
CREATE TABLE Rent
(rid int, vlicense char(7), dlicense char(7),  fromDate timestamp, toDate timestamp, odometer real, cardName char(30), cardNo int, ExpDate int, confNo int,
PRIMARY KEY (rid),
FOREIGN KEY (dlicense) REFERENCES Customer,
...
CREATE TABLE Return
(rid int, rdate timestamp, odometer real, fulltank char(1), value real, 
PRIMARY KEY (rid),
